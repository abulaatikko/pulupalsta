...
<head>
    ...
    <title><?php $view['slots']->output('title', 'Project-Z') ?></title>
...
<ul id="navigation">
<li <?php echo $app->getRequest()->get('_route') == 'pulu_palsta_front' ? 'class="current"' : '' ?>><a href="<?php echo $view['router']->path('pulu_palsta_front') ?>">Intro</a></li>
...
<p id="copyright">&copy; <a href="https://lassi.pulu.org">Abulaatikko</a>, 2000&ndash;<?php echo date('Y'); ?></p>
