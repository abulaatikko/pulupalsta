...
<?php foreach ($recentComments as $comment): ?>
    <item>
        ...
        <link>https:<?php echo $view['router']->url('pulu_palsta_article', array('article_number' => $comment->getArticle()->getArticleNumber(), 'name' => $view['helper']->toFilename($comment->getArticle()->getName($locale))), true) ?></link>
