...
<p>Pulupalsta is a playground project to practice web development and writing skills.</p>

<p>The first article (<a href="http://palsta.pulu.org/fi/1-1500-litraa-pepsiC3A4-ja-sony-vaio-s5">1500 litres of Pepsi and Sony Vaio S5</a>) was written in January 2006. The Pepsi project was a primary reason to create this web site, titled <em>Puluprojects</em> back then. The platform was upgraded to Symfony PHP framework in 2012 and a fancy administration portal was created. See <a href="<?php echo $view['assets']->getUrl('bundles/pulupalsta/text/CHANGELOG.txt') ?>">CHANGELOG.txt</a> for more history details.</p>
