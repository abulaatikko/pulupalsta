...
<h1>A user of internet, welcome! <a style="float: right" href="<?php echo $view['router']->path('pulu_palsta_list') ?>#feeds" title="RSS Feeds"><img src="<?php echo $view['assets']->getUrl('bundles/pulupalsta/images/icons/32_feed.png') ?>" alt="RSS Feeds" /></a></h1>

<p>Hi, I'm Lassi in real life and Abula in internet life. I'm a web developer and this is my playground project. I've also created some content for the universe. The top-10 most popular articles are in <strong>bold</strong>.</p>
